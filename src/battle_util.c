...
u8 AtkCanceller_UnableToUseMove(void)
{
    ...
    do
    {
        ...
        case CANCELLER_FROZEN: // check being frozen
            ...
            {
                if (RandomWeighted(WRNG_FROZEN, 1, 4))
                {
        ...
        case CANCELLER_CONFUSED: // confusion
            if (gBattleMons[gBattlerAttacker].status2 & STATUS2_CONFUSION)
            {
                ...
                if (gBattleMons[gBattlerAttacker].status2 & STATUS2_CONFUSION)
                {
                    ...
                    if (RandomWeighted(WRNG_CONFUSION, 2, 1))
                #else
                    if (RandomWeighted(WRNG_CONFUSION, 1, 1))
                #endif
                    {
        ...
        case CANCELLER_PARALYSED: // paralysis
            if ((gBattleMons[gBattlerAttacker].status1 & STATUS1_PARALYSIS) && RandomWeighted(WRNG_PARALYSIS, 3, 1))
            {
        ...
        case CANCELLER_IN_LOVE: // infatuation
            if (gBattleMons[gBattlerAttacker].status2 & STATUS2_INFATUATION)
            {
                ...
                if (!RandomWeighted(WRNG_INFATUATION, 1, 1))
                {
                    BattleScriptPushCursor();
                }
                else
    ...
    case ABILITYEFFECT_MOVE_END: // Think contact abilities.
        ...
        case ABILITY_POISON_POINT:
            if (!(gMoveResultFlags & MOVE_RESULT_NO_EFFECT)
             ...
             && IsMoveMakingContact(move, gBattlerAttacker)
             && RandomWeighted(WRNG_POISON_POINT, 2, 1))
            {
        ...
        case ABILITY_STATIC:
            if (!(gMoveResultFlags & MOVE_RESULT_NO_EFFECT)
             ...
             && IsMoveMakingContact(move, gBattlerAttacker)
             && RandomWeighted(WRNG_STATIC, 2, 1))
            {
        ...
        case ABILITY_FLAME_BODY:
            if (!(gMoveResultFlags & MOVE_RESULT_NO_EFFECT)
             ...
             && RandomWeighted(WRNG_FLAME_BODY, 2, 1))
            {
        ...
        case ABILITY_CUTE_CHARM:
            if (!(gMoveResultFlags & MOVE_RESULT_NO_EFFECT)
             ...
             && TARGET_TURN_DAMAGED
             && gBattleMons[gBattlerTarget].hp != 0
             && RandomWeighted(WRNG_CUTE_CHARM, 2, 1)
    ...
    case ABILITYEFFECT_MOVE_END_ATTACKER: // Same as above, but for attacker
        ...
        case ABILITY_STENCH:
            if (!(gMoveResultFlags & MOVE_RESULT_NO_EFFECT)
             && gBattleMons[gBattlerTarget].hp != 0
             && !gProtectStructs[gBattlerAttacker].confusionSelfDmg
             && RandomWeighted(WRNG_STENCH, 9, 1)
             && !IS_MOVE_STATUS(move)
    ...
    case ITEMEFFECT_KINGSROCK:
        ...
        case HOLD_EFFECT_FLINCH:
            ...
            if (gBattleMoveDamage != 0  // Need to have done damage
                ...
                && TARGET_TURN_DAMAGED
                && RandomWeighted(WRNG_HOLD_EFFECT_FLINCH, 100-atkHoldEffectParam, atkHoldEffectParam)
